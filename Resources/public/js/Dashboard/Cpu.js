Lugosium.Dashboard.Cpu = {
    ...
    {
        try {
            $('#dashboard').append('<div id="cpu-chart"></div>');
            var _updateCallback = function() {
                try {
                    var cpuData = Lugosium.Dashboard.getData(Lugosium.Dashboard.Cpu.getRestParams());
            ...
            Lugosium.Dashboard.Cpu.createVpsCpuMonitor();
